...
CREATE TABLE `contratos` (
  ...
  CONSTRAINT `fk_usuario_creacion` FOREIGN KEY (`UsuarioCreacionId`) REFERENCES `usuarios` (`idusuarios`),
...
CREATE TABLE `pagos` (
  ...
  KEY `pagos_ibfk_2` (`UsuarioCreacionId`),
  KEY `pagos_ibfk_3` (`UsuarioAnulacionId`),
...
INSERT INTO `usuarios` VALUES (1,'Julian','Rios',234636598,'admin@gmail.com','admin','admin123','perfil_1_638838903274505818.jpg',1),(2,'Pepe','Argento',351662549,'pepe@gmail.com','empleado','pepe123','perfil_2_638838909096788624.jpg',1),(3,'Mercedes','Sosa',2664001235,'mercedes@gmail.com','empleado','merce123','perfil_3_638838947244430027.jpg',1);
...
-- Dump completed on 2025-05-26 22:37:43
